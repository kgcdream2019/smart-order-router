import { ChainId, Token } from '@yumyumswap/sdk-core';
...
const SUBGRAPH_URL_BY_CHAIN: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.BASE]:
    'https://api.studio.thegraph.com/query/49959/yumyum-subgraph-base/version/latest',
  [ChainId.BASE_GOERLI]:
    'https://api.studio.thegraph.com/query/45375/yumyumswap-subgraph/version/latest',
  [ChainId.PULSE]:
