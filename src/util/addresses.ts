import { CHAIN_TO_ADDRESSES_MAP, ChainId, Token } from '@yumyumswap/sdk-core';
...
export const BASE_SWAP_ROUTER_02_ADDRESS =
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  CHAIN_TO_ADDRESSES_MAP[ChainId.BASE].swapRouter02Address!;
export const BASE_GOERLI_SWAP_ROUTER_02_ADDRESS =
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  CHAIN_TO_ADDRESSES_MAP[ChainId.BASE_GOERLI].swapRouter02Address!;
export const PULSE_SWAP_ROUTER_02_ADDRESS =
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  CHAIN_TO_ADDRESSES_MAP[ChainId.PULSE].swapRouter02Address!;
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.PULSE]: CHAIN_TO_ADDRESSES_MAP[ChainId.PULSE].v3CoreFactoryAddress,
...
export const QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  [ChainId.PULSE]: CHAIN_TO_ADDRESSES_MAP[ChainId.PULSE].quoterAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
};
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = {
  ...
  [ChainId.PULSE]: CHAIN_TO_ADDRESSES_MAP[ChainId.PULSE].multicallAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
};
